...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Scenith's AI banner generator is accessible via our AI Image Generation tool. The free BASIC plan lets you explore the tool, with paid plans starting from ₹99/month offering generous image credits. Each credit generates one high-resolution banner image with no watermarks and full commercial rights.",
  },
  {
          ...
          <div className="deepdive-grid">
            ...
            <aside className="deepdive-aside">
              ...
              <div className="aside-card">
                ...
                <p>Professional designer: ₹5,000–₹50,000/project. Scenith AI: from ₹99/month for unlimited iterations.</p>
              </div>
              <div className="aside-card">
            ...
            <table className="compare-table" aria-label="AI banner generator comparison">
              ...
              <tbody>
                {[
                  ...
                  ['Pricing (India)', '₹99/mo+', '₹899/mo+', '₹1,999/mo+', '$10/mo+'],
