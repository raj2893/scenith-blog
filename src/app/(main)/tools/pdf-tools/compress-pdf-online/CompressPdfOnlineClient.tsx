...
const TOOL_URL =
  "https://scenith.in/tools/pdf-tools/compress-pdf?utm_source=compress_pdf_online&utm_medium=cta_button&utm_campaign=seo_landing_page";

const TOOL_URL_SECONDARY =
  "https://scenith.in/tools/pdf-tools/compress-pdf?utm_source=compress_pdf_online&utm_medium=inline_link&utm_campaign=seo_landing_page";
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "WebApplication",
                "@id": "https://scenith.in/tools/pdf-tools/compress-pdf-online#webapp",
                ...
                url: "https://scenith.in/tools/pdf-tools/compress-pdf-online",
              ...
              },
              {
                "@type": "BreadcrumbList",
                "@id":
                  "https://scenith.in/tools/pdf-tools/compress-pdf-online#breadcrumb",
                itemListElement: [
                  {
                    "@type": "ListItem",
                    position: 1,
                  ...
                  },
                  {
                    ...
                    item: "https://scenith.in/tools/pdf-tools/compress-pdf-online",
                  },
                ],
              },
              {
                "@type": "FAQPage",
                "@id":
                  "https://scenith.in/tools/pdf-tools/compress-pdf-online#faq",
                mainEntity: [
                  {
                    "@type": "Question",
              ...
              },
              {
                "@type": "HowTo",
                "@id":
                  "https://scenith.in/tools/pdf-tools/compress-pdf-online#howto",
