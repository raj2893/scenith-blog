...
const pdfToolsStructuredData = {
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "@id": "https://scenith.in/tools/pdf-tools#webapp",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://scenith.in/tools/pdf-tools#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "FAQPage",
      "@id": "https://scenith.in/tools/pdf-tools#faq",
      "mainEntity": [
        {
          "@type": "Question",
    ...
    {
      "@type": "HowTo",
      "@id": "https://scenith.in/tools/pdf-tools#howto-merge",
...
// Generate tool schemas AFTER tools array is defined
  const toolSchemas = tools.map((tool) => ({
    ...
    "@id": `https://scenith.in/tools/pdf-tools/${tool.id}`,
