...
export const metadata: Metadata = {
  ...
  description:
    "Best free PDF tools for India. Merge, split, compress, rotate & convert PDFs online – no installation, no hidden fees. Trusted by 1 lakh+ Indians. Works on mobile & PC.",
  keywords: [
  ...
  openGraph: {
    title: "Free PDF Tools for India – No Watermark, No Limits",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Free PDF Tools Online India – Merge Split Compress PDF",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Free PDF Tools India – No Watermark",
    description:
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "We use SSL encryption for all uploads and automatically delete your files within 1 hour of processing. That said, for highly sensitive documents like Aadhaar, PAN, or financial records, we recommend using offline PDF software for maximum privacy. For general documents – certificates, forms, college papers – our tool is completely safe.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Absolutely. The tools are fully mobile-optimised and tested on popular Android devices used in India including Redmi, Realme, Samsung Galaxy, and OnePlus phones running Chrome or Firefox. No app download needed – works directly in browser.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Never. Unlike many free PDF sites that add their branding to your documents, Scenith outputs clean, professional PDFs with zero watermarks – whether you merge, compress, split, or convert. Free forever, no hidden premium tier needed to remove watermarks.",
          },
        },
        {
          "@type": "Question",
      ...
      step: [
        {
          ...
          text: "Click the 'Open PDF Tools' button on this page. Select the operation you need – Merge, Split, Compress, Rotate, Convert, Watermark, Lock or Unlock.",
        },
        {
          "@type": "HowToStep",
          position: 2,
  ...
  return (
    <div className="india-pdf-page">
      ...
      <section className="india-why-section" aria-labelledby="why-india">
        <div className="india-container">
          ...
          <p className="india-section-intro">
            ...
            every bank document – it's all PDF. Yet most Indians are still forwarding WhatsApp links to shady
          ...
          <div className="india-reality-grid">
            <article className="india-reality-card">
              <div className="india-reality-icon">📋</div>
              <h3>Government Portals Have Strict File Limits</h3>
              <p>
                DigiLocker, UMANG, NPS, PF portal, income tax e-filing – most government websites cap uploads
              ...
              <div className="india-reality-stat">
                ₹0 cost • Works on every government portal
              </div>
            </article>
            ...
            <article className="india-reality-card">
              ...
              <p>
                Engineering admissions, MBA applications, scholarship forms, internship applications – every
            ...
            <article className="india-reality-card">
              ...
              <p>
                Most Indian HR departments still use Outlook or company mail servers configured in 2009 – with
              ...
              <div className="india-reality-stat">
                Reduces average resume PDF from 12MB → under 2MB
              </div>
            </article>
            ...
            <article className="india-reality-card">
              ...
              <p>
                Home loan applications, credit card submissions, KYC updates – banks routinely ask for "last 3
                ...
                scanning, no more paying the cyber cafe ₹10 per page.
              </p>
              <div className="india-reality-stat">
                Split any range: pages 5–8, every alternate page, or all individually
              </div>
            </article>
            ...
            <article className="india-reality-card">
              ...
              <p>
                ...
                impression. <strong>Rotate PDF</strong> fixes orientation in 3 seconds – 90°, 180°, 270° – and
                you're done.
              </p>
              <div className="india-reality-stat">
      ...
      <section className="india-tools-section" aria-labelledby="all-tools">
        <div className="india-container">
          <h2 id="all-tools">All 9 Free PDF Tools – What Each One Does</h2>
          <p className="india-section-intro">
            One platform. Nine tools. Every PDF task covered – from the most common (merging, compressing) to
          ...
          <div className="india-tools-list">
            ...
            <div className="india-tool-row">
              <div className="india-tool-meta">
                <span className="india-tool-emoji">📎</span>
                <div>
                  <h3>Merge PDF</h3>
              ...
              <div className="india-tool-desc">
                ...
                <ul className="india-tool-bullets">
                  ...
                  <li>Original quality preserved – zero re-compression</li>
            ...
            <div className="india-tool-row india-tool-row--alt">
              <div className="india-tool-meta">
                <span className="india-tool-emoji">✂️</span>
                <div>
                  <h3>Split PDF</h3>
              ...
              <div className="india-tool-desc">
                <p>
                  Extract specific pages or ranges from any PDF. Split by page range (pages 3–7), split every
                ...
                <ul className="india-tool-bullets">
                  <li>Custom page ranges (e.g., "1–3, 5, 8–12")</li>
            ...
            <div className="india-tool-row">
              ...
              <div className="india-tool-desc">
                <p>
                  ...
                  Low/Medium/High preset compression, or use the custom slider (1–99%) to hit an exact target size
                ...
                <ul className="india-tool-bullets">
                  ...
                  <li>Custom compression slider (1–99%)</li>
                  <li>Text remains crisp even at high compression</li>
                  <li>No watermark added – ever</li>
                </ul>
              </div>
            </div>
            ...
            <div className="india-tool-row india-tool-row--alt">
              ...
              <div className="india-tool-desc">
                <p>
                  ...
                  pages. Options: 90° clockwise, 90° counter-clockwise, or 180° flip. The fix is permanent in the
                  output file – no viewer settings needed.
                </p>
                <p>
            ...
            <div className="india-tool-row">
              ...
              <div className="india-tool-desc">
                <p>
                  Stamp a text watermark – "DRAFT", "CONFIDENTIAL", your name, company name, or any custom text –
            ...
            <div className="india-tool-row india-tool-row--alt">
              ...
              <div className="india-tool-desc">
                ...
                <p>
                  ...
                  with foreign universities. Many banks in India already send PDF statements with a password – now
            ...
            <div className="india-tool-row">
              ...
              <div className="india-tool-desc">
                <p>
                  Remove password protection from a PDF you own. You must know the current password to unlock it –
                ...
                <ul className="india-tool-bullets">
                  ...
                  <li>Combine with Compress PDF for an unlock → compress → upload workflow</li>
          ...
          <div className="india-secondary-cta-wrapper">
            <Link href={mainCTAUrl} className="india-secondary-cta" target="_blank" rel="noopener noreferrer">
              Use All 9 PDF Tools Free – Open Now →
            </Link>
          </div>
      ...
      <section className="india-workflows-section" aria-labelledby="india-workflows">
        <div className="india-container">
          ...
          <p className="india-section-intro">
            Here are the exact document workflows that bring millions of Indians to PDF tools every month –
          ...
          <div className="india-workflow-grid">
            ...
            <div className="india-workflow-card">
              ...
              <ol className="india-workflow-steps">
                ...
                <li>Upload to portal – done in under 5 minutes total</li>
              </ol>
              <div className="india-workflow-tip">
                💡 Pro tip: Always check the portal's file size limit before compressing. Some portals accept 5MB,
                others only 500KB.
              </div>
            </div>
            ...
            <div className="india-workflow-card">
              ...
              <p className="india-workflow-context">
                ...
                property documents – all as separate PDFs or one combined file.</em>
              </p>
              <ol className="india-workflow-steps">
              ...
              <div className="india-workflow-tip">
                💡 Pro tip: Add watermark to documents you submit to multiple banks simultaneously – helps track
            ...
            <div className="india-workflow-card">
              ...
              <p className="india-workflow-context">
                <em>Scenario: Competitive exam portals impose very strict file size limits (often 100–500KB per
              ...
              <div className="india-workflow-tip">
                💡 Pro tip: Save compressed versions in a dedicated folder labelled with the exam name and year.
            ...
            <div className="india-workflow-card">
              ...
              <ol className="india-workflow-steps">
                ...
                <li>Use <strong>Lock PDF</strong> before emailing to CA – share password over WhatsApp separately</li>
                <li>Use <strong>Compress PDF</strong> before attaching to email if the file exceeds 10MB</li>
              </ol>
              <div className="india-workflow-tip">
                💡 Pro tip: Lock your proposal PDFs before sharing for approval – prevents the client from editing
        ...
        <div className="india-container">
          ...
          <div className="india-users-grid">
            ...
            <div className="india-user-card">
              <div className="india-user-icon">🎓</div>
            ...
            <div className="india-user-card">
              ...
              <p>
                ...
                offer letters – all need to be organised, compressed, and presented correctly.
              </p>
              <div className="india-user-detail">
            ...
            <div className="india-user-card">
              ...
              <p>
                GST registration, Udyam registration, FSSAI license, shop act registration – the Indian
            ...
            <div className="india-user-card">
              <div className="india-user-icon">⚖️</div>
            ...
            <div className="india-user-card">
              ...
              <p>
                Medical reports, prescriptions, health insurance claims, CGHS/ESIC paperwork – Indian healthcare
          ...
          <div className="india-tertiary-cta-wrapper">
            <Link href={mainCTAUrl} className="india-tertiary-cta" target="_blank" rel="noopener noreferrer">
              <span>📄 Open PDF Tools Now – Free for Everyone →</span>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="india-container">
          ...
          <div className="india-mobile-grid">
            <div className="india-mobile-card">
              <span className="india-mobile-icon">📱</span>
              <h3>Works on ₹8,000 Phones</h3>
              <p>
            ...
            <div className="india-mobile-card">
              ...
              <p>
                We're actively building a Hindi-language version of the interface (हिंदी UI) for users who
      ...
      {/* ══════════════════════════════════════
          PRIVACY SECTION – INDIA-SPECIFIC
      ══════════════════════════════════════ */}
      <section className="india-privacy-section" aria-labelledby="india-privacy">
        <div className="india-container">
          ...
          <p className="india-section-intro">
            This is the most important question for Indian users, and it deserves a straight answer – not
            marketing fluff.
          </p>

          <div className="india-privacy-grid">
            <div className="india-privacy-card india-privacy-card--safe">
              <h3>✅ Safe for These Documents</h3>
              <ul>
            ...
            <div className="india-privacy-card india-privacy-card--caution">
              <h3>⚠️ Use Offline Tools for These</h3>
              <ul>
          ...
          <div className="india-privacy-explanation">
            ...
            <p>
              ...
              processing – usually much sooner – all copies of your file are permanently deleted from our
              servers. We don't store, analyse, or use your document data in any way. We have no reason to –
      ...
      <section className="india-compare-section" aria-labelledby="compare-tools">
        <div className="india-container">
          ...
          <p className="india-section-intro">
            Many Indians land on international tools that either charge in USD, have strict file limits, or – worst of
            all – add watermarks without telling you upfront. Here's the honest comparison.
          </p>
            ...
            <table className="india-compare-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="india-table-best">₹0 – Forever free</td>
                ...
                <tr className="india-table-alt">
                  ...
                  <td className="india-table-best">❌ Never</td>
                  <td>Some tools</td>
                  <td>✅ On free plan</td>
                  <td>✅ On most tools</td>
                </tr>
                <tr className="india-table-alt">
                  ...
                  <td className="india-table-best">✅ Fully optimised</td>
                  <td>Acceptable</td>
                  <td>Acceptable</td>
                ...
                <tr className="india-table-alt">
                  ...
                  <td className="india-table-best">✅ Within 1 hour</td>
                ...
                <tr>
                  ...
                  <td className="india-table-best">₹0</td>
                  <td>~₹800/month</td>
                  <td>~₹1,200/month</td>
                  <td>~₹1,700/month</td>
                </tr>
          ...
          <div className="india-compare-callout">
            ...
            watermarks, or create an account – Scenith is the most straightforward option available today.
          </div>
        </div>
      </section>
        ...
        <div className="india-container">
          ...
          <div className="india-paa-grid">
            ...
            <div className="india-paa-item">
              <h3>क्या PDF merge करना free है? (Is PDF merging free?)</h3>
              <p>
                हाँ, Scenith पर PDF merge करना बिल्कुल free है। कोई account नहीं बनाना, कोई limit नहीं, कोई
                watermark नहीं। Yes – merging PDFs on Scenith is completely free with no hidden steps.
              </p>
            </div>
            ...
            <div className="india-paa-item">
              ...
              <p>
                ...
                "maximum 500KB" or "between 100–300KB".
              </p>
            </div>
            ...
            <div className="india-paa-item">
              ...
              <p>
                Use Scenith's custom compression slider. Set it to 85–95% compression. For text-heavy documents
                like marksheets and certificates, this typically brings a 2–3MB file to under 100KB while keeping
                text readable. For image-heavy documents, use 70–80% and check the output quality before submitting.
              </p>
            </div>
            ...
            <div className="india-paa-item">
              ...
              <p>
                ...
                certificates, and general forms, Scenith is safe – files are deleted within 1 hour.
              </p>
            </div>
            ...
            <div className="india-paa-item">
              ...
              <p>
                For Indian students, Scenith covers the full document workflow: scan photos → Images to PDF →
                Merge PDF → Compress PDF → submit to portal. It's free, requires no account, has no watermarks,
            ...
            {[
              {
                ...
                a: "No – browser-based PDF tools require an internet connection because processing happens on remote servers. However, if you frequently work without internet access, consider downloading PDF24 Desktop (free, offline, Windows) or using LibreOffice (free, all platforms). For occasional internet access, Scenith processes most files in under 10 seconds, so even a brief 4G connection is enough.",
              },
              {
                q: "How many PDFs can I merge at once?",
                a: "There's no hard limit on the number of PDFs you can merge in one session. Practically, merging 10–20 PDFs works smoothly. If you're merging very large files (50MB+ each), processing may take slightly longer depending on your internet speed and the complexity of each document.",
              },
              {
                q: "Why is my compressed PDF still large?",
                a: "PDF compression works best on image-heavy files. If your PDF is mostly high-resolution scanned images (common with documents scanned at 600 DPI at cyber cafes), even high compression may leave a file larger than expected. Try compressing at 90–95% using the custom slider. For very large scans, consider re-scanning at 150–200 DPI before creating the PDF.",
              },
              {
                q: "Can I recover a PDF if I forget the password after locking it?",
                a: "No. AES-256 encrypted PDFs cannot be recovered without the correct password – even by us. This is by design (it's what makes encryption secure). Always store your PDF passwords in a password manager or a secure note. Common mistake: people use their date of birth as the password and then forget whether they used DD/MM/YYYY or DDMMYYYY format.",
              },
              {
                q: "Are there any PDF tools free for commercial use in India?",
                a: "Yes. Scenith's tools can be used for commercial purposes – creating client deliverables, business proposals, company documents, and so on. There's no restriction on commercial use for the tools themselves. The only thing you can't do is resell Scenith's service or white-label it without permission.",
              },
              {
                q: "My PDF file shows an error on the government portal – what should I do?",
                a: "Common reasons for portal rejection: (1) File too large – use Compress PDF, (2) Wrong format – ensure it's PDF/A if the portal specifically asks for it (rare), (3) Password-protected – use Unlock PDF first, (4) Corrupted file – try re-creating the PDF from the source document. Most Indian government portal errors are due to file size exceeding limits.",
              },
              {
      ...
      <section className="india-final-cta-section" aria-labelledby="final-cta">
        <div className="india-container">
          <div className="india-final-cta-content">
            <span className="india-final-icon">🇮🇳</span>
            <h2 id="final-cta">
              Free PDF Tools for Every Indian – No Exceptions
            </h2>
            <p>
              Student or professional. Tier 1 city or Tier 3 town. Android or iPhone. Jio or Airtel.
              Scenith's PDF tools work for everyone in India – free, no account, no watermark, no fine print.
            ...
            <Link href={mainCTAUrl} className="india-final-cta-btn" target="_blank" rel="noopener noreferrer">
              <span className="india-final-cta-left">
                ...
                <small>9 Tools • Zero Signup • No Watermark • Works on Mobile</small>
              </span>
              <span className="india-final-arrow">→</span>
            </Link>
            <div className="india-final-trust">
              <span>✅ 1 लाख+ भारतीय उपयोगकर्ता</span>
