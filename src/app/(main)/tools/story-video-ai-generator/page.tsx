  ...
  "@graph": [
    ...
    },
    {
      ...
      offers: {
        ...
        price: "0",
        priceCurrency: "INR",
        description: "Free to start. Credit-based plans from $9/mo.",
      },
      featureList: [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Scenith offers a credit-based model with starter credits for new accounts. Paid plans begin at $9/month. Generating a story video scene (5 seconds, 1080p) costs between 10 and 50 credits depending on the AI model selected.",
          },
        },
        {
          "@type": "Question",
