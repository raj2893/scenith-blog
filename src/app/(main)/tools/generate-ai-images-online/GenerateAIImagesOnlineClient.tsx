...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Scenith\'s AI Image Generator offers 7 powerful models including photorealistic and anime pipelines, all accessible via a clean web interface with no Discord or CLI required. Plans start free with paid credit bundles from $9/month.',
  },
  {
