...
const FAQ = [
  ...
  },
  {
    ...
    a: "Scenith offers a credit-based system with plans starting at $9/month. New accounts receive starter credits to try the generator. Different models consume different credit amounts — Wan 2.5 costs 10 credits for a 5-second Short while Veo 3 costs 50 credits.",
  },
  {
        ...
        <section className={styles.hero} aria-labelledby="hero-heading">
          ...
          <div className={styles.heroCtas}>
            ...
            <p className={styles.ctaNote}>
              No credit card needed to start &nbsp;·&nbsp; Plans from $9/mo &nbsp;·&nbsp; 1080p output
            </p>
          </div>
