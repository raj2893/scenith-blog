      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Scenith offers a free trial with limited credits. Paid plans start at $9/month and give you access to multiple AI models including Kling 2.5 and Veo 3 for generating educational videos.",
          },
        },
        {
          "@type": "Question",
          ...
          <section className={styles.hero}>
            ...
            <div className={styles.ctaBlock}>
              ...
              <p className={styles.ctaMeta}>
                No credit card required to preview · Plans from $9/month · 1080p MP4 output
              </p>
            </div>
          </section>
              ...
              {[
                {
                  ...
                  a: "Scenith offers a free trial with limited credits so you can test the tool before committing. Paid plans start at $9/month and unlock access to all four AI models including Kling 2.5 Pro and Veo 3. There is no free tier with unlimited generation — high-quality AI video generation requires significant compute, and we price it as fairly as possible.",
                },
                {
