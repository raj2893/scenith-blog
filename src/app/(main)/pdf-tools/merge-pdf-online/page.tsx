...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://scenith.in/pdf-tools/merge-pdf-online",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://scenith.in/pdf-tools/merge-pdf-online",
    languages: {
      "en-US": "https://scenith.in/pdf-tools/merge-pdf-online",
    },
  },
  other: {
...
const CTA_URL =
  "https://scenith.in/pdf-tools/merge-pdf?utm_source=merge-pdf-online&utm_medium=landing_page&utm_campaign=pdf_tools_seo";
...
export default function MergePdfOnlinePage() {
  const schemaData = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://scenith.in/pdf-tools/merge-pdf-online#webpage",
        url: "https://scenith.in/pdf-tools/merge-pdf-online",
        ...
        breadcrumb: {
          "@id":
            "https://scenith.in/pdf-tools/merge-pdf-online#breadcrumb",
        },
        inLanguage: "en-US",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: "https://scenith.in/pdf-tools/merge-pdf-online",
          },
        ],
      },
      {
        "@type": "FAQPage",
        "@id": "https://scenith.in/pdf-tools/merge-pdf-online#faq",
        mainEntity: [
          {
            "@type": "Question",
      ...
      {
        "@type": "HowTo",
        "@id": "https://scenith.in/pdf-tools/merge-pdf-online#howto",
      ...
      >
        <div className="mpo-container">
          ...
          <div className="mpo-related-grid">
            ...
            <a  href="https://scenith.in/pdf-tools/split-pdf?utm_source=merge-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
            ...
            <a  href="https://scenith.in/pdf-tools/compress-pdf?utm_source=merge-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="mpo-related-card"
            >
              <span className="mpo-related-icon" aria-hidden="true">
                🗜️
            ...
            <a  href="https://scenith.in/pdf-tools/rotate-pdf?utm_source=merge-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="mpo-related-card"
            >
              <span className="mpo-related-icon" aria-hidden="true">
                🔄
            ...
            <a  href="https://scenith.in/pdf-tools/unlock-pdf?utm_source=merge-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="mpo-related-card"
            >
              <span className="mpo-related-icon" aria-hidden="true">
                🔓
