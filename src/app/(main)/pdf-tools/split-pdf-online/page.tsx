...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://scenith.in/pdf-tools/split-pdf-online",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://scenith.in/pdf-tools/split-pdf-online",
    languages: {
      "en-US": "https://scenith.in/pdf-tools/split-pdf-online",
    },
  },
  other: {
...
const CTA_URL =
  "https://scenith.in/pdf-tools/split-pdf?utm_source=split-pdf-online&utm_medium=landing_page&utm_campaign=pdf_tools_seo";
...
export default function SplitPdfOnlinePage() {
  const schemaData = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://scenith.in/pdf-tools/split-pdf-online#webpage",
        url: "https://scenith.in/pdf-tools/split-pdf-online",
        ...
        breadcrumb: {
          "@id": "https://scenith.in/pdf-tools/split-pdf-online#breadcrumb",
        },
        inLanguage: "en-US",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Split PDF Online", item: "https://scenith.in/pdf-tools/split-pdf-online" },
        ],
      },
      {
        "@type": "FAQPage",
        "@id": "https://scenith.in/pdf-tools/split-pdf-online#faq",
        mainEntity: [
          {
            "@type": "Question",
      ...
      {
        "@type": "HowTo",
        "@id": "https://scenith.in/pdf-tools/split-pdf-online#howto",
      ...
      <section className="spo-section spo-related" aria-labelledby="related-title">
        <div className="spo-container">
          ...
          <div className="spo-related-grid">
            ...
            <a  href="https://scenith.in/pdf-tools/merge-pdf?utm_source=split-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
            ...
            <a  href="https://scenith.in/pdf-tools/compress-pdf?utm_source=split-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="spo-related-card"
            >
            ...
            <a  href="https://scenith.in/pdf-tools/rotate-pdf?utm_source=split-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="spo-related-card"
            >
              <span className="spo-related-icon" aria-hidden="true">🔄</span>
              <div>
            ...
            <a  href="https://scenith.in/pdf-tools/unlock-pdf?utm_source=split-pdf-online&utm_medium=related_tools&utm_campaign=pdf_tools_seo"
              className="spo-related-card"
            >
              <span className="spo-related-icon" aria-hidden="true">🔓</span>
              <div>
