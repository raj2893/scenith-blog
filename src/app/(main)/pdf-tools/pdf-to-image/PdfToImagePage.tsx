...
const TOOL_URL =
  "https://scenith.in/pdf-tools/pdf-to-images?utm_source=pdf-to-image&utm_medium=cta&utm_campaign=seo-landing";
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "WebPage",
                "@id": "https://scenith.in/pdf-tools/pdf-to-image#webpage",
                ...
                breadcrumb: { "@id": "https://scenith.in/pdf-tools/pdf-to-image#breadcrumb" },
              },
              {
                "@type": "BreadcrumbList",
                "@id": "https://scenith.in/pdf-tools/pdf-to-image#breadcrumb",
                itemListElement: [
                  ...
                  { "@type": "ListItem", position: 2, name: "PDF Tools", item: "https://scenith.in/pdf-tools" },
                  {
                    ...
                    item: "https://scenith.in/pdf-tools/pdf-to-image",
                  },
                ],
              },
              {
                "@type": "HowTo",
                "@id": "https://scenith.in/pdf-tools/pdf-to-image#howto",
              ...
              {
                "@type": "FAQPage",
                "@id": "https://scenith.in/pdf-tools/pdf-to-image#faq",
                mainEntity: [
                  {
                    "@type": "Question",
              ...
              },
              {
                ...
                "@id": "https://scenith.in/pdf-tools/pdf-to-image#software",
