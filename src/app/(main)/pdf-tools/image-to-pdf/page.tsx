...
const TOOL_URL =
  "https://scenith.in/pdf-tools/images-to-pdf?utm_source=photo-to-pdf-page&utm_medium=cta&utm_campaign=photo_to_pdf_organic";
...
export default function PhotoToPdfPage() {
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://scenith.in/pdf-tools/photo-to-pdf#webpage",
        url: "https://scenith.in/pdf-tools/photo-to-pdf",
        ...
        breadcrumb: {
          "@id": "https://scenith.in/pdf-tools/photo-to-pdf#breadcrumb",
        },
      },
      {
        "@type": "BreadcrumbList",
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: "https://scenith.in/pdf-tools/photo-to-pdf",
          },
        ],
      },
      {
        "@type": "SoftwareApplication",
        "@id": "https://scenith.in/pdf-tools/photo-to-pdf#app",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://scenith.in/pdf-tools/photo-to-pdf#faq",
        mainEntity: [
          {
            "@type": "Question",
      ...
      {
        "@type": "HowTo",
        "@id": "https://scenith.in/pdf-tools/photo-to-pdf#howto",
